...
graph TD
    %% Root
    A[Antigravity Agents Factory] --> B(docs-as-code-ecosystem/)
    A --> C(knowledge/vector-store/)
    A --> D(Future Ecosystems...)

    %% Knowledge Base
    C --> C1[423+ Optimized Neo-CRISPE Skills]
    ...
    classDef ecosystem fill:#1E293B,stroke:#3B82F6,stroke-width:1px,color:#E2E8F0
    classDef asset fill:#334155,stroke:#94A3B8,stroke-width:1px,color:#F1F5F9
    
    class A root
    class B,C,D ecosystem
    class C1,B1,B2,B3,B4 asset
```
