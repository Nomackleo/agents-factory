...
- Estándares de Diseño: Jerarquía tipográfica suiza, contrastes WCAG 2.1 AA, paletas de `DESIGN.md`.
...
3. **Formateo Tipográfico y Cromático:** Aplicación de tokens de marca en cajas de texto y encabezados.
4. **Incrustación de Gráficos y Renders:** Inserción de imágenes y diagramas vectoriales generados por otros ecosistemas.
</statement_of_task>
...
- Tipografía y Contraste: Garantizar legibilidad a distancia ($4.5:1$ de contraste mínimo).
</constraints>
